...
export default function WhyInvest() {
  ...
  return (
    <section id="why-invest" className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-32 select-none">
      
      {/* Title & Cards Side-by-Side Flex Layout */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-start relative z-10">
        ...
        <div className="xl:col-span-4 lg:sticky lg:top-32 select-none">
          ...
          <p className="font-sans text-sm text-slate-400 mt-6 max-w-sm leading-relaxed font-light">
          ...
          <motion.div 
            ...
            className="mt-8 h-[2px] bg-gradient-to-r from-brand-blue to-transparent" 
          />
        </div>
        ...
        <div className="xl:col-span-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 xl:grid-cols-5 gap-4">
          {items.map((item, index) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-6 flex flex-col items-center text-center justify-between border border-white/5 transition-all duration-[400ms] group min-h-[300px] relative overflow-hidden cursor-default shadow-md"
            >
              ...
              <div className="mt-6 flex flex-col justify-center items-center">
                <h4 className="font-display font-semibold text-sm text-white group-hover:text-brand-blue transition-colors duration-300 tracking-tight leading-snug">
                  {item.title}
                </h4>
                
                {/* Description */}
                <p className="font-sans text-[11px] text-slate-400 mt-4 leading-relaxed line-clamp-4 group-hover:text-slate-200 transition-colors duration-300">
                  {item.description}
                </p>
              </div>

              {/* Badge */}
              <div className="mt-6 border border-white/5 bg-slate-950/70 px-2.5 py-1 rounded-full group-hover:border-brand-blue/10 transition-all duration-300">
                <span className="font-mono text-[8px] tracking-wider text-slate-500 group-hover:text-brand-blue/60 transition-colors uppercase font-bold">
                  {item.badge}
                </span>
              </div>
            </motion.div>
